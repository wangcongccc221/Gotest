...
- 更新时间: 2026-06-30T08:41:07+08:00
- 开始时间: 2026-06-30T08:41:05+08:00
- 停止原因: startup failed
- Base URL: `http://127.0.0.1:2778`
- WebSocket URL: `ws://127.0.0.1:2778/ws`
- Run ID: `codex-verify-20260630`
- 测试 FType: `None`
- 计划时长: 28800 秒
- 每轮数据量: 10 行
- 每轮间隔: 60 秒
...
- 最长轮次耗时: 0.000 秒
- 平均轮次耗时: 0.000 秒
- 最近错误: /ping network error: [WinError 10061] 由于目标计算机积极拒绝，无法连接。

## 最近步骤耗时

| 步骤 | 耗时秒 | 结果 | 说明 |
| --- | ---: | --- | --- |
| readiness | 2.073 | FAIL | /ping network error: [WinError 10061] 由于目标计算机积极拒绝，无法连接。 |
...
事件流水文件: `reports\db_ws_stability\codex-verify-20260630\events.jsonl`
