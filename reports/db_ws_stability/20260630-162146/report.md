...
- 更新时间: 2026-06-30T16:21:46+08:00
- 开始时间: 2026-06-30T16:21:46+08:00
- 停止原因: once complete
- Base URL: `http://127.0.0.1:2778`
- WebSocket URL: `ws://127.0.0.1:2778/ws`
- Run ID: `20260630-162146`
- 测试 FType: `9000`
- 计划时长: 28800 秒
- 每轮数据量: 20 行
- 每轮间隔: 60 秒
...
| --- | ---: | --- | --- |
| readiness | 0.054 | OK |  |
| choose_empty_fault_type | 0.027 | OK |  |
| save_base_faults | 0.046 | OK |  |
...
事件流水文件: `reports\db_ws_stability\20260630-162146\events.jsonl`
