...
- 更新时间: 2026-06-30T16:19:30+08:00
- 开始时间: 2026-06-30T16:19:30+08:00
- 停止原因: startup failed
- Base URL: `http://127.0.0.1:2778`
- WebSocket URL: `ws://127.0.0.1:2778/ws`
- Run ID: `20260630-161930`
- 测试 FType: `None`
- 计划时长: 28800 秒
- 每轮数据量: 20 行
- 每轮间隔: 60 秒
...
| 步骤 | 耗时秒 | 结果 | 说明 |
| --- | ---: | --- | --- |
| readiness | 0.024 | FAIL | /ping network error: [WinError 10054] 远程主机强迫关闭了一个现有的连接。 |
...
事件流水文件: `reports\db_ws_stability\20260630-161930\events.jsonl`
