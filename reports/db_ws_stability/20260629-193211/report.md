...
- 更新时间: 2026-06-29T19:32:11+08:00
- 开始时间: 2026-06-29T19:32:11+08:00
- 停止原因: once complete
- Base URL: `http://127.0.0.1:2778`
- WebSocket URL: `ws://127.0.0.1:2778/ws`
- Run ID: `20260629-193211`
- 测试 FType: `9000`
- 计划时长: 60 秒
- 每轮数据量: 10 行
- 每轮间隔: 1 秒
...
| --- | ---: | --- | --- |
| readiness | 0.060 | OK |  |
| choose_empty_fault_type | 0.024 | OK |  |
| save_base_faults | 0.047 | OK |  |
| read_base_faults | 0.028 | OK |  |
| websocket_probe | 0.034 | OK |  |
...
事件流水文件: `reports\db_ws_stability\20260629-193211\events.jsonl`
