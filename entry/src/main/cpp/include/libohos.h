...
extern double GoAdd(double x, double y);
extern char* GoHello(void);
extern void GoFreeCString(char* value);
extern int GoStartServer(void);
extern int GoStopServer(void);
extern int GoStartOPCUAServer(void);
extern int GoStopOPCUAServer(void);
extern int GoStartModbusServer(void);
extern int GoStopModbusServer(void);
extern int GoInitORM(void);
extern int GoInitORMWithPath(char* path);
...
extern char* GoStGlobalLayoutReport(void);
extern char* GoLastCTCPStGlobalFullJSON(void);
