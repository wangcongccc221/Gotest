# Install this pet: npx codex-pets add jiyi
_Exported on 05/23/2026 at 15:47:43 GMT+8 from OpenAI Codex via WayLog_
...
Using `superpowers:using-superpowers` for the session rule check; the actual task is a direct CLI install, so I’m going straight to the command.
...
Installed `jiyi` successfully.

Output:
```text
Installed Jiyi (jiyi)
C:\Users\AI008\.codex\pets\jiyi
```
