# 我想修改内哦让那个
_Exported on 06/12/2026 at 13:34:40 GMT+8 from OpenAI Codex via WayLog_
...
- browser:control-in-app-browser: Control the in-app Browser. Use to open, navigate, inspect, test, click, type, screenshot, or verify local targets such as localhost, 127.0.0.1, ::1, file://, the current in-app browser tab, and websites shown side by side inside Codex. (file: r3/browser/26.608.12217/skills/control-in-app-browser/SKILL.md)
