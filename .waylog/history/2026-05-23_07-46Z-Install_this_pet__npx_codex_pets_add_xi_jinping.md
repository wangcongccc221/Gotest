# Install this pet: npx codex-pets add xi-jinping
_Exported on 05/23/2026 at 15:46:41 GMT+8 from OpenAI Codex via WayLog_
...
Using `superpowers:using-superpowers` for the required skill check; no pet-building skill is needed here because this is an install command, not sprite creation or packaging.
...
Installed `xi-jinping` with `npx --yes codex-pets add xi-jinping`.

Output: `Installed Xi Jinping (xi-jinping)`  
Path: `C:\Users\AI008\.codex\pets\xi-jinping`

No compile/build step was run.
