# Install this pet: npx codex-pets add remu
...
Installed Remu successfully.

Path: `C:\Users\AI008\.codex\pets\remu`

`npx` also installed `codex-pets@0.3.0` to run the command.
